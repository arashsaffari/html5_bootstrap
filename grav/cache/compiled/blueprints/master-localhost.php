...
return [
    ...
    'timestamp' => 1548692787,
    'checksum' => '31005b53c2e067552a426c3589ac8d3a',
    'files' => [
        ...
        'user/plugins' => [
            'plugins/shortcode-assets' => [
                'file' => 'user/plugins/shortcode-assets/blueprints.yaml',
                'modified' => 1548692562
            ],
    ...
    'data' => [
        'items' => [
            ...
            'plugins.shortcode-assets.enabled' => [
                'type' => 'toggle',
                'label' => 'Plugin status',
                'highlight' => 1,
                'default' => 0,
                ...
                'name' => 'plugins.shortcode-assets.enabled',
                'validation' => 'strict'
            ],
            'plugins.markdown-notices' => [
                'type' => '_root',
        ...
        'nested' => [
            ...
            'plugins' => [
                'shortcode-assets' => [
                    'enabled' => 'plugins.shortcode-assets.enabled'
                ],
                'markdown-notices' => [
