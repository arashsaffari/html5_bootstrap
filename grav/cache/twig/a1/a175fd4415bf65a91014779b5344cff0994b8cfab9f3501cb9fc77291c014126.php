...
class __TwigTemplate_71c0dee0a0739d46c58691283f3e7238ba18d34edc8af40284fd889a5128cb5b extends Twig_Template
{
    ...
    <div class=\"row\">
                        ...
                        <div class=\"row\">
                            ...
                            <div class=\"col-sm-10\">
                                <div class=\"form-check form-check-inline\">
                                    <input class=\"form-check-input\" type=\"radio\" name=\"data[anrede]\" id=\"anrede_female\" value=\"Frau\" if uri.query endif><label class=\"form-check-label\" for=\"anrede_female\">Frau</label>
                                </div>
                                <div class=\"form-check form-check-inline\">
        ...
        echo "\" class=\"form-control\" id=\"firmenname\"></div>
                    <div class=\"form-group\">
                        ...
                        <select name=\"data[companytype]\" class=\"form-control\" id=\"companytype\" autocomplete=\"on\"><option value=\"\"></option><option value=\"typea\" if uri.query endif>Type A</option><option value=\"typeb\" if uri.query endif>Type B</option></select></div>
                    <div class=\"form-group\">
