...
class __TwigTemplate_64deb8e8342506fdb013cc61ffa2b089cf31850ca93841acdf287f9eae5593e0 extends Twig_Template
{
    ...
    <div class=\"row\">
        ...
        echo "
            ";
        // line 11
        echo $this->getAttribute(($context["macros"] ?? null), "input", [0 => "name", 1 => "value", 2 => "type", 3 => "size"], "method");
        echo "
            ";
        // line 12
    ...
    <div class=\"row\">
        <div class=\"col-lg-6\">
            <!--%form_massage%-->
            {{ my_test(\"Test\") }}
            {{ macros.input('name', 'value', 'type', 'size') }}
