...
class __TwigTemplate_e9098c5a7c7285e77fdd3622f228fd586d9877e0597e8fafcddade0575c10755 extends Twig_Template
{
    ...
    <div class=\"row\">
        <div class=\"col-lg-6\">
            ...
            ";
        // line 10
        $context["macros"] = $this->loadTemplate("macros/macros.html.twig", "@Page:/Users/arashsaffari/Datein/Web Server/htdocs/html5_bootstrap/grav/user/pages/03.kontakt", 10);
        // line 11
        echo "            ";
        echo $context["macros"]->getmyhallo(twig_escape_filter($this->env, $this->getAttribute(($context["form"] ?? null), "value", [0 => "firmenname"], "method"), "html_attr"));
        echo "
    ...
    <div class=\"row\">
        <div class=\"col-lg-6\">
            ...
            {{ macros.myhallo(form.value('firmenname')|e('html_attr')) }}
            <form name=\"kontakt\" action=\"\" method=\"POST\" id=\"kontakt\">
                <fieldset><div class=\"form-group\">
                        <label for=\"firmenname\">Firmenname:</label>
