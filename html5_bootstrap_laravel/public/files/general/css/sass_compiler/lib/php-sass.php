...
class SassWatcher
{
    ...
    public $scss_compiler;

    function __construct($scssphp_script_path = "./scss.inc.php") {
     ...
     */
    public function watch($scss_folder, $css_folder, $interval, $format_style = "scss_formatter")
    {
        ...
        while(1) {
            ...
            $this->compile_scss($scss_folder, $css_folder, $interval, $format_style);
            // wait for X seconds
            sleep($interval);
        }
    }
    ...
    public function compile_scss($scss_folder, $css_folder, $interval, $format_style = "scss_formatter"){

        
        // set the path to your to-be-imported mixins. please note: custom paths are coming up on future releases!
        $this->scss_compiler->setImportPaths($scss_folder);
        // set css formatting (normal, nested or minimized), @see http://leafo.net/scssphp/docs/#output_formatting
        $this->scss_compiler->setFormatter($format_style);
        ...
        foreach ($filelist as $file_path) {
            ...
            try {
                ...
                $string_css = $this->scss_compiler->compile($string_sass);
